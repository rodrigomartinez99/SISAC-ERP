...
    
    try {
      console.log('🌐 Enviando petición a: https://nxp44knk8ww8.share.zrok.io/api/auth/login');
      
      const response = await fetch('https://nxp44knk8ww8.share.zrok.io/api/auth/login', {
      
        method: 'POST',
        headers: {
...
        body: JSON.stringify(credentials),
        // credentials: 'include', // <--- LÍNEA ELIMINADA
      });
...
    try {
      const response = await fetch('https://nxp44knk8ww8.share.zrok.io/api/auth/validate', {
        method: 'GET',
        headers: {
...
    try {
      const response = await fetch('https://nxp44knk8ww8.share.zrok.io/api/auth/user-info', {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
