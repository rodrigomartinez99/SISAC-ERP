...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-09-2025 a las 13:48:37
...
--
-- Indices de la tabla `boletas_pago`
--
...
--
-- Indices de la tabla `calendario_obligaciones`
--
...
--
-- Indices de la tabla `parametros_tributarios`
--
...
--
-- Indices de la tabla `presupuesto_planilla`
--
...
--
-- Indices de la tabla `reportes_oficiales`
--
...
--
-- AUTO_INCREMENT de la tabla `boletas_pago`
--
ALTER TABLE `boletas_pago`
  MODIFY `idBoleta` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `calendario_obligaciones`
--
ALTER TABLE `calendario_obligaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `parametros_tributarios`
--
ALTER TABLE `parametros_tributarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `presupuesto_planilla`
--
ALTER TABLE `presupuesto_planilla`
...
--
-- AUTO_INCREMENT de la tabla `reportes_oficiales`
--
ALTER TABLE `reportes_oficiales`
...
--
-- Filtros para la tabla `boletas_pago`
--
ALTER TABLE `boletas_pago`
...
--
-- Filtros para la tabla `calendario_obligaciones`
--
ALTER TABLE `calendario_obligaciones`
...
--
-- Filtros para la tabla `parametros_tributarios`
--
ALTER TABLE `parametros_tributarios`
